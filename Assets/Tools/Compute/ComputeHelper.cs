...
public static class ComputeHelper
{
    ...
    //public static void SwizzleTexture(Texture texture, ComputeShaderUtility.Channel x, ComputeShaderUtility.Channel y, ComputeShaderUtility.Channel z, ComputeShaderUtility.Channel w)
    //{
    ...
    //static Vector4 ChannelToMask(ComputeShaderUtility.Channel channel)
    //{
    //	switch (channel)
    //	{
    //		case ComputeShaderUtility.Channel.Red:
    //			return new Vector4(1, 0, 0, 0);
    //		case ComputeShaderUtility.Channel.Green:
    //			return new Vector4(0, 1, 0, 0);
    //		case ComputeShaderUtility.Channel.Blue:
    //			return new Vector4(0, 0, 1, 0);
    //		case ComputeShaderUtility.Channel.Alpha:
    //			return new Vector4(0, 0, 0, 1);
    //		case ComputeShaderUtility.Channel.Zero:
